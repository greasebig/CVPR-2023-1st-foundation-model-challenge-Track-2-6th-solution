...
**更新时间**: 2026-09-09 06:49:43

**论文数量**: 110

---

## 1. Mask Forcing: Improving Autoregressive Video Diffusion Distillation via Dual-Noise Masking Rollout
...
## 2. Spheriverse: 3D Scene Understanding from Spherical Observations in the Wild
...
## 4. DSE-VTG: Dual-Side Enhancement for Training-Free Video Temporal Grounding
...
## 5. Beyond Gait: Person Identification from Millimeter-Wave Point Clouds Across Activities of Daily Living
...
## 7. CausalChapter: Improving Long-Video Chaptering with Interventional Dependency Modeling
...
## 8. From Where to How: Continuous 4D Interaction Forecasting from Egocentric Video
...
## 9. STSG-VQA: Evidence-Grounded Temporal Question Answering from Surgical Spatio-Temporal Scene Graphs
...
## 10. Temporal State Transport in Video Generation: Diagnosing and Correcting Spectral Imbalance
...
## 11. SignRefine: Adapting Foundational Video Models for Sign Language Generation
...
## 12. From Coordinates to Candidate Regions: Temporal Change Localization via Region Selection in Remote Sensing Multimodal LLMs
...
## 13. ReMoMask-2: Latent Retrieval-Augmented Masked Motion Generation
...
## 14. Segment Any Motion with Radar: Robust Multimodal Moving-Object Segmentation and Tracking
...
## 15. VeriScene: Reconstructing Crime Scenes from Legal Evidence via World-Model Agent
...
## 16. EdMCGS: Event-Driven Markov Chain Gaussian Splatting for Extreme-Low-Frame-Rate Dynamic Scene Reconstruction
...
## 17. Do Input-Level Defenses Transfer to Observation-Level Attacks on VideoLLMs?
...
## 18. Online Signature Verification Using Augmented Path Signature and T-Mamba
...
## 19. Tracking-by-detection in Multi-object Tracking: Survey and Experiments
...
## 20. ActionSplice: In-Flight Action Editing for Interactive World Models
...
## 21. Drive by Hindsight and Foresight: Tool-Grounded Synergistic Reasoning over Hierarchical Memory for Autonomous Driving
...
## 22. PhysFlow: Physics-Aware Optical Flow for Motion Controllable Video Generation
...
## 23. WSPolypNet: Weakly Supervised Polyp Localization in Colonoscopy Videos
...
## 24. Geodesic-informed Generative Diffusion Model For Topology-preserved Image Video Generation
...
## 25. RevalExo: A Functional Daily-Activity Benchmark for Inertial and Visual Locomotion Mode Recognition in Older Adults and Clinical Cohorts
...
**arXiv ID**: [2609.08090v1](http://arxiv.org/abs/2609.08090v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.08090v1)
...
## 26. VI-Bench: Benchmarking Prompt Inversion from AIGC Videos
...
## 27. TANGO: Humanoid Navigation in Cluttered Environments with a Whole-Body Vision-Language-Action Model
...
## 28. NOAH: Learning the Full Patient Journey. A Longitudinal Multimodal Time-Aware Model for Representation and Forecasting
...
## 29. Time-Varying Data as Sheaves: an Invitation to Narratives
...
## 30. OntoKG-EQ: A provenance-grounded, competency-question-governed knowledge graph for auditable analyst querying
...
## 31. Adaptive Anisotropic Attention for Axis-Structured Signals
...
## 32. Application of curiosity driven exploration methods for hardware interference identification
...
## 33. Neptune: An AI model for Global Ocean Subseasonal Prediction
...
## 34. Graph-Based Personalized Memory for LLM Agents: Representation, Evolution, Retrieval, and Evaluation
...
## 35. Beyond Coherence: Benchmarking Professional Editing-Technique Execution in Multi-Shot Audio-Video Generation
...
## 36. MemForest: Efficient Agent Memory Management via EventTree Partitioning and Progressive Merging
...
## 37. Synergistic Fusion of Topological Structure and Temporal Semantics of Mobility for Urban Region Embedding
...
## 38. TTGBench: Benchmarking Topological Evolution and Semantic Drift in Text-attributed Temporal Graphs
...
## 39. Dual-Layer Semantic-Spatial Belief Mapping for Aerial Object Goal Navigation
...
## 40. FOCI Policy: Focus on Object-Centric Interactions for Relational Manipulation Policies
...
## 41. Seeing is Not Believing: Breaking the Physical-to-Digital Trust Boundary in Robotics
...
## 42. Learning Length-Extrapolatable Recurrent Models
...
## 43. Multi-Task Learning for Sparsely-Labeled Time Series: A Case Study on Cold-Hardiness Modeling
...
## 44. HypLTSF: A Hyperbolic Geometric View of Multi-Scale Hierarchies for Long-Term Time Series Forecasting
...
## 45. A Machine Learning Framework for Predicting Restaurant Food Waste to Support Sustainable Food Management
...
## 46. A Gradient-based yet Spike-Timing-Dependent Solution to the Feedback Learning Problem in Neural Microcircuits
...
## 47. A Quantitative Evaluation Framework for Temporal Explainability in Echocardiographic Video Segmentation
...
## 48. Flexible Motion Generation from Language and Style References
...
## 49. A Black-Box Adversarial Attack on Human Pose Estimation and Keypoint-Based Action Recognition Models
...
## 50. ReactVAU: A Slow-Fast Decoupled Framework for Streaming Video Anomaly Understanding
...
**arXiv ID**: [2609.07941v1](http://arxiv.org/abs/2609.07941v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07941v1)

**项目主页**: https://huiyuiui.github.io/React_VAU/
...
## 51. Better Call CineCrew: Consistent Ultra-Long Narrative-to-Film Generation
...
## 52. Search-to-World: Evaluation of 3D World Delivery from User Request through Web Search
...
## 53. Parser-Free VLM Verification for Federated Weakly Supervised Video Anomaly Detection
...
## 54. Unified Vision-Centric Pedestrian Crossing Action Prediction via Adaptive Patch Projection and Proactive Spatial Rectification
...
## 55. DF26: We Cannot Tell Fake From Real Anymore
...
## 56. CRISP: Corneal Confocal Microscopy Real-Time Image Stitching Pipeline
...
**arXiv ID**: [2609.07336v1](http://arxiv.org/abs/2609.07336v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07336v1)
...
## 57. The Price of Consistency: Exploiting Visual Anchors for Multimodal Jailbreaking in Video Generation
...
## 58. A Two-Stage Framework for Ego-Centric Key Object Identification via Object State Prediction
...
## 59. CASCADE: A Spatio-Temporal-Causal Reasoning Representation and Dataset for Driving

**中文标题**: CASCADE: A Spatio-Temporal-Causal Reasoning Representation and Dataset for Driving

**作者**: Jenny Schmalfuss, Despoina Paschalidou, Simon Gerstenecker, German Ros, Jose M. Alvarez

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07094v1](http://arxiv.org/abs/2609.07094v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07094v1)

**项目主页**: https://huggingface.co/datasets/nvidia/cascade.
...
## 60. Continuous Token-Level Spatio-Temporal Context Modeling for Visual Object Tracking

**中文标题**: Continuous Token-Level Spatio-Temporal Context Modeling for Visual Object Tracking

**作者**: Ding Xia, Meiqin Liu, Jing Zhou, Jian Lan

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07070v1](http://arxiv.org/abs/2609.07070v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07070v1)

**代码仓库**: https://github.com/xiading123/TLCTrack.
...
## 61. Fine-Grained Visual Preprocessing and Dual-Stream Temporal Modeling for Multimodal Sentiment Analysis on Social Media

**中文标题**: Fine-Grained Visual Preprocessing and Dual-Stream Temporal Modeling for Multimodal Sentiment Analysis on Social Media

**作者**: Su Li, Yigong Zhang, Lei Xiong, Chune Li

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07010v1](http://arxiv.org/abs/2609.07010v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07010v1)
...
## 62. NeuCME: Toward Dynamic Multimodal Continual Learning via Neural Combinatorics of Multiple Experts

**中文标题**: NeuCME: Toward Dynamic Multimodal Continual Learning via Neural Combinatorics of Multiple Experts

**作者**: Kai Guo, Chuanbin Liu, Peng Hu, Hao Wang, Xi Peng

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07009v1](http://arxiv.org/abs/2609.07009v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07009v1)
...
## 63. AV-SafetyBench: A Safety Benchmark for Text-to-Audio-Video Generation

**中文标题**: AV-SafetyBench: A Safety Benchmark for Text-to-Audio-Video Generation

**作者**: Suah Choi, Tae-Young Lee, Gyeong-Moon Park

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06991v1](http://arxiv.org/abs/2609.06991v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06991v1)
...
## 64. AnomalyCraft-700K: Component-Level Controllable and Verifiable Synthetic Anomalies for Fine-Grained Video Anomaly Understanding

**中文标题**: AnomalyCraft-700K: Component-Level Controllable and Verifiable Synthetic Anomalies for Fine-Grained Video Anomaly Understanding

**作者**: Yuzhou Long, Haodong Zhang, Yunpeng Yang, Peng Wu, Guansong Pang

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06978v1](http://arxiv.org/abs/2609.06978v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06978v1)
...
## 65. Joint-Conditioned Stereo Surface Reasoning for Interaction Field Estimation

**中文标题**: Joint-Conditioned Stereo Surface Reasoning for Interaction Field Estimation

**作者**: Yanlin Jin, Yifan Yang, Bowen Yang, Kai Zhu

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06955v1](http://arxiv.org/abs/2609.06955v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06955v1)
...
## 66. PRG-Fusion: Orchestrating Generative Priors with Reconstruction Evidence for Driving View Synthesis

**中文标题**: PRG-Fusion: Orchestrating Generative Priors with Reconstruction Evidence for Driving View Synthesis

**作者**: Sipeng He, Jialei Chen, Zhen Fang, Dongchun Ren, Feng Zhao

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06948v1](http://arxiv.org/abs/2609.06948v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06948v1)
...
## 67. Explainable Temporal Attention-based Defect Detection For Fillet Joints in Real-Time Gas Metal Arc Welding Based on Multi-modal Data
...
## 68. A*-Thought-V2: Efficient Latent Reasoning via Geometric Dynamics of LLM
...
## 69. Zero-Shot Sim-to-Real Contact-Rich Assembly via Proprioception-Anchored Cross-Modal Pretraining
...
## 70. Quantile-Led Feature Extraction for Multi-Horizon Predictive Maintenance in Industrial Manufacturing Systems

**中文标题**: Quantile-Led Feature Extraction for Multi-Horizon Predictive Maintenance in Industrial Manufacturing Systems

**作者**: David J Poland, Daniele Ravi, Na Helian

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07533v1](http://arxiv.org/abs/2609.07533v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07533v1)
...
## 71. PV-WM: A Heterogeneous Micro-Macro World Model for Articulated Pedestrian-Vehicle Co-Rollout
...
## 72. REFINE: Trajectory Representation Learning via Closed-Loop Transcription -- Extended Version

**中文标题**: REFINE: Trajectory Representation Learning via Closed-Loop Transcription -- Extended Version

**作者**: Sean Bin Yang, Ying Sun, Jilin Hu, Zongyi Xu, Kristian Torp et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07206v1](http://arxiv.org/abs/2609.07206v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07206v1)
...
## 73. From LLM-Generated Specifications to Learned Quadruped Locomotion
...
## 74. Beyond Sparse Rewards: A New Benchmark and Structure-Aware Graph Alignment for Micro-Drama Understanding

**中文标题**: Beyond Sparse Rewards: A New Benchmark and Structure-Aware Graph Alignment for Micro-Drama Understanding

**作者**: Yixin Qin, Shi-Zhe Chen, Zhiqi Yu, Siyuan Cheng, Tao Cheng et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07107v1](http://arxiv.org/abs/2609.07107v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07107v1)

**代码仓库**: https://github.com/qyx1121/MDrama_SAGA.
...
## 75. Temporal Heterogeneous Graph Transformer for Credit Card Fraud Detection

**中文标题**: Temporal Heterogeneous Graph Transformer for Credit Card Fraud Detection

**作者**: Qinwen Yan

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07100v1](http://arxiv.org/abs/2609.07100v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07100v1)
...
## 76. SSP-DMGTimeNet: Physics-Constrained Learning for Spatiotemporal Trajectory Prediction of Vehicle Platoons

**中文标题**: SSP-DMGTimeNet: Physics-Constrained Learning for Spatiotemporal Trajectory Prediction of Vehicle Platoons

**作者**: Yuhang Wang, Kailang Ma, Zirui Li, Mingfeng Fan, Kitae Jang et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06961v1](http://arxiv.org/abs/2609.06961v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06961v1)
...
**中文标题**: iBrain: A Unified Foundation Model Reading the Brain from Surface to Spikes

**作者**: Ying Chen, Tiou Wang, Zhifeng Yue

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06960v1](http://arxiv.org/abs/2609.06960v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06960v1)
...
## 78. PCSDiff: Diffusion-Based Bias Correction and Super Resolution Toward Practical Operational Medium-Term Precipitation Forecast

**中文标题**: PCSDiff: Diffusion-Based Bias Correction and Super Resolution Toward Practical Operational Medium-Term Precipitation Forecast

**作者**: Yuze Sun, Shiyi Wang, Jiancheng Pan, Die Wang, Andreas F. Prein et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06942v1](http://arxiv.org/abs/2609.06942v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06942v1)
...
## 79. AdoDAS: A Privacy-Preserving Multimodal Challenge for Adolescent Depression, Anxiety, and Stress Assessment

**中文标题**: AdoDAS: A Privacy-Preserving Multimodal Challenge for Adolescent Depression, Anxiety, and Stress Assessment

**作者**: Zhaojie Luo, Junkun Wang, Tianhua Qi, Yuxuan Wu, Xin Zhao et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07038v1](http://arxiv.org/abs/2609.07038v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07038v1)
...
## 80. ICI-VLA: In-Context Imitation with Spatiotemporally Aligned Demonstrations for Vision-Language-Action Models
...
## 81. Functional-SLAM: Interaction-Aware Mapping with Online Functional Scene Graphs
...
## 82. Phase-and-First-Arrival VLM Feedback for Sparse-Reward Reinforcement Learning in Surgical Manipulation
...
## 83. Beyond Task Success: Stage-Wise Reliability of World Model Planning under Sensing Degradation
...
## 84. RoboDreamer: Anticipatory Humanoid Locomotion with Predictive State-Space Models

**中文标题**: RoboDreamer: Anticipatory Humanoid Locomotion with Predictive State-Space Models

**作者**: Zhe Li, Yangyang Wei, Xichen Yuan, Zhenzhe Zhang, Weihao Yuan et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07096v1](http://arxiv.org/abs/2609.07096v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07096v1)
...
## 85. Decomposition-Guided Diffusion Language Models for Inertial Confinement Fusion Prediction

**中文标题**: Decomposition-Guided Diffusion Language Models for Inertial Confinement Fusion Prediction

**作者**: Xiang Zhang, Varchas Gopalaswamy, Rahman Ejaz, Riccardo Betti, Dongfang Liu

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07756v1](http://arxiv.org/abs/2609.07756v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07756v1)
...
## 86. Local gradient neural operator

**中文标题**: Local gradient neural operator

**作者**: Baiming Zhang, Jinsong Tang, Ying Xu, Lihua Chen, Shiying Xiong

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07752v1](http://arxiv.org/abs/2609.07752v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07752v1)
...
## 87. Translation of Black-Box Clinical Prediction Models into Standalone Transparent Nomograms: Temporal External Validation in Heart Transplantation

**中文标题**: Translation of Black-Box Clinical Prediction Models into Standalone Transparent Nomograms: Temporal External Validation in Heart Transplantation

**作者**: Henry Pigot, Paulo J. G. Lisboa, Sandra Ortega-Martorell, Ivan Olier, Joseph Mahon et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07610v1](http://arxiv.org/abs/2609.07610v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07610v1)
...
## 88. Temporal-Causal Inference for Reinforcement Learning via Automata Learning

**中文标题**: Temporal-Causal Inference for Reinforcement Learning via Automata Learning

**作者**: Jan Corazza, Daniil Kaminskyi, Simon Lutz, Patrick Nossol, Hadi Partovi Aria et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07461v1](http://arxiv.org/abs/2609.07461v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07461v1)
...
## 89. Inferring Urban Mobility Interactions from Aggregated Dynamics

**中文标题**: Inferring Urban Mobility Interactions from Aggregated Dynamics

**作者**: Yi Wang, Jing Li, Jinliang Deng, Zhenghong Wang, Yizhi Zhang et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.07349v1](http://arxiv.org/abs/2609.07349v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.07349v1)
...
## 90. AF-Mamba: Efficient Long-Term Signal Modeling for Early Prediction of Atrial Fibrillation Onset

**中文标题**: AF-Mamba: Efficient Long-Term Signal Modeling for Early Prediction of Atrial Fibrillation Onset

**作者**: Yongbin Lee, Ki H. Chon

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06984v1](http://arxiv.org/abs/2609.06984v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06984v1)
...
## 91. HealthLoopQA: A Context-Aware Question Answering Benchmark for Interpreting Wearable Monitoring Data in Diabetes Care

**中文标题**: HealthLoopQA: A Context-Aware Question Answering Benchmark for Interpreting Wearable Monitoring Data in Diabetes Care

**作者**: Yuchen Niu, Yanan Ma, Srinivasan Nandakumar, Maolin Chen, Viktor Schlegel et al.

**发布日期**: 2026-09-07

**arXiv ID**: [2609.06976v1](http://arxiv.org/abs/2609.06976v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06976v1)
...
## 92. RAIDAL: Redundancy-Aware Information Density Active Learning for CTC-Based Continuous Sign Language Recognition

**中文标题**: RAIDAL: Redundancy-Aware Information Density Active Learning for CTC-Based Continuous Sign Language Recognition

**作者**: Rafael A. Diniz Augusto, Gabriel L. Oliveira, Erickson R. Nascimento

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06843v1](http://arxiv.org/abs/2609.06843v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06843v1)
...
## 93. Generalist Open-World Temporal Perception

**中文标题**: Generalist Open-World Temporal Perception

**作者**: Cristian Sminchisescu

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06823v1](http://arxiv.org/abs/2609.06823v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06823v1)
...
## 94. When Speech Meets Lips: Interpretable Audio-Visual Synchronization for L2 Pronunciation Assessment

**中文标题**: When Speech Meets Lips: Interpretable Audio-Visual Synchronization for L2 Pronunciation Assessment

**作者**: Bowen Yu, Mingyu Huang, Yishen Liu, Yue Zhao

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06788v1](http://arxiv.org/abs/2609.06788v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06788v1)

**项目主页**: https://www.robots.ox.ac.uk/~vgg/data/lip_reading/.
...
## 95. RoLA: Rotary-Positioned Low-Rank Linear Attention for Efficient Diffusion Transformers

**中文标题**: RoLA: Rotary-Positioned Low-Rank Linear Attention for Efficient Diffusion Transformers

**作者**: Zekun Zhang, Yixiang Cai, Yuxi Liu, Tengxu Sun, Tianle Liu et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06712v1](http://arxiv.org/abs/2609.06712v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06712v1)
...
## 96. When Does a Laugh Begin? Structured Annotator Disagreement in Temporal Laughter Localization

**中文标题**: When Does a Laugh Begin? Structured Annotator Disagreement in Temporal Laughter Localization

**作者**: Eyal Hanania, Daniel Arkushin, Naveh Ayal, Jonathan Benvenisti, Amos Bercovich et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06646v1](http://arxiv.org/abs/2609.06646v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06646v1)

**代码仓库**: https://github.com/WSCSports/SMILE-Disagreement
...
## 97. Physico-Geospatial Grounded Scene Interpretation for Mobile Robotics

**中文标题**: Physico-Geospatial Grounded Scene Interpretation for Mobile Robotics

**作者**: Nicolas Schuler, Janik Kurtz, Lea Dewald, Marcel Sauber, Félicia Teferle et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06629v1](http://arxiv.org/abs/2609.06629v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06629v1)

**项目主页**: https://datahub.rz.rptu.de/hstr-csrl-public/publications/physico-geospatial-grounded-scene-interpretation
...
## 98. GeoCo-SAVi: Geometry-Consistent Slot Attention for Explicitly Editable Object Representations

**中文标题**: GeoCo-SAVi: Geometry-Consistent Slot Attention for Explicitly Editable Object Representations

**作者**: Haoxiang Huang, Zhekai Wang, Xiang Liu, Sen Cui, Changshui Zhang

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06628v1](http://arxiv.org/abs/2609.06628v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06628v1)
...
## 99. Learning to Use Imagination: Progress-Conditioned Future Utilization for World Action Models

**中文标题**: Learning to Use Imagination: Progress-Conditioned Future Utilization for World Action Models

**作者**: Yijie Zhu, Zitong Yu, Wei Li, Hui Ma, Wen Li et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06578v1](http://arxiv.org/abs/2609.06578v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06578v1)
...
## 100. Thinking with Cameras: Active Visual Reasoning via Dynamic Viewpoint Control for Surveillance Video Understanding

**中文标题**: Thinking with Cameras: Active Visual Reasoning via Dynamic Viewpoint Control for Surveillance Video Understanding

**作者**: Xiao Zhang, Wang Zeng, Sheng Jin, Wentao Liu, Chen Qian et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06475v1](http://arxiv.org/abs/2609.06475v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06475v1)

**代码仓库**: https://github.com/xiaozhang79/CamVLM
...
## 101. MVWeaver: A Hierarchical Music Video Generation Agent with a Learned Song-to-Visual Bridge

**中文标题**: MVWeaver: A Hierarchical Music Video Generation Agent with a Learned Song-to-Visual Bridge

**作者**: Sifei Li, Minyan Luo, Xu Li, Guodong Qi, Xincan Wang et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06478v1](http://arxiv.org/abs/2609.06478v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06478v1)
...
## 102. RoboSense: Leveraging Robotaxi Fleets as Drive-by Sensors for Urban Traffic Monitoring

**中文标题**: RoboSense: Leveraging Robotaxi Fleets as Drive-by Sensors for Urban Traffic Monitoring

**作者**: Yilin Wang, Yiheng Feng

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06813v1](http://arxiv.org/abs/2609.06813v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06813v1)
...
## 103. SkillX: Unified Multi-Skill Policy Learning for Humanoid Soccer

**中文标题**: SkillX: Unified Multi-Skill Policy Learning for Humanoid Soccer

**作者**: Zhangchen Ye, Enxuan Ruan, Yifei Bao, Runhan Huang, Jiankun Yang et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06718v1](http://arxiv.org/abs/2609.06718v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06718v1)
...
## 104. VLA-Corrector: Stage-Aware Observable State Understanding for Prompt-Based Closed-Loop Recovery of Vision-Language-Action Policies

**中文标题**: VLA-Corrector: Stage-Aware Observable State Understanding for Prompt-Based Closed-Loop Recovery of Vision-Language-Action Policies

**作者**: Chang Song, Bin Qian, Yan Feng, Zhijie Song

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06508v1](http://arxiv.org/abs/2609.06508v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06508v1)
...
## 105. Can People Distinguish Human and AI Agency in Humanoid Teleoperation? A Preliminary Study of Agency Perception

**中文标题**: Can People Distinguish Human and AI Agency in Humanoid Teleoperation? A Preliminary Study of Agency Perception

**作者**: Xiang Li, Koya Dendo, Keigo Minamida, Yuto Nakamura, Per Ola Kristensson et al.

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06434v1](http://arxiv.org/abs/2609.06434v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06434v1)
...
## 106. PPIM: Pennes Physics-Informed Mamba for Heat-Source-Conditioned 3D Bioheat Simulation

**中文标题**: PPIM: Pennes Physics-Informed Mamba for Heat-Source-Conditioned 3D Bioheat Simulation

**作者**: Dongyun Lee, Kyungho Yoon, Minwoo Shin

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06869v1](http://arxiv.org/abs/2609.06869v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06869v1)

**代码仓库**: https://github.com/muvYun/PPIM.
...
## 107. TD-STGT: A Spatio-Temporal Graph Transformer for Mobile Traffic Demand Forecasting

**中文标题**: TD-STGT: A Spatio-Temporal Graph Transformer for Mobile Traffic Demand Forecasting

**作者**: Mohamad Alkadamani, Halim Yanikomeroglu

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06636v1](http://arxiv.org/abs/2609.06636v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06636v1)
...
## 108. Certifying cooperation: a novel approach to cooperative multi-agent task generation

**中文标题**: Certifying cooperation: a novel approach to cooperative multi-agent task generation

**作者**: Yannick Molinghen, Hugo Charels, Tom Lenaerts

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06586v1](http://arxiv.org/abs/2609.06586v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06586v1)
...
## 109. Introductory Notes on Learning$^2$

**中文标题**: Introductory Notes on Learning$^2$

**作者**: Sai Siddharth, Maniarasu Ravi

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06546v1](http://arxiv.org/abs/2609.06546v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06546v1)
...
## 110. Role-Specific Predictive Geometries for Nonstationary Multivariate Graph-Signal Forecasting

**中文标题**: Role-Specific Predictive Geometries for Nonstationary Multivariate Graph-Signal Forecasting

**作者**: Yanbo Chen, Anamitra Makur

**发布日期**: 2026-09-06

**arXiv ID**: [2609.06519v1](http://arxiv.org/abs/2609.06519v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2609.06519v1)

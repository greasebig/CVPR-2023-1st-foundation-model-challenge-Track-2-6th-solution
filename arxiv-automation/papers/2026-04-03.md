...
## 78. Out of Sight, Out of Track: Adversarial Attacks on Propagation-based Multi-Object Trackers via Query State Manipulation
...
## 79. The 1st Winner for 5th PVUW MeViS-Text Challenge: Strong MLLMs Meet SAM3 for Referring Video Object Segmentation
...
## 80. Semantically Annotated Multimodal Dataset for RF Interpretation and Prediction
...
## 81. Can LLMs Predict Academic Collaboration? Topology Heuristics vs. LLM-Based Link Prediction on Real Co-authorship Networks
...
## 82. Adversarial Moral Stress Testing of Large Language Models
...
## 83. Temporal Dependencies in In-Context Learning: The Role of Induction Heads
...
## 84. Sampling-based Task and Kinodynamic Motion Planning under Semantic Uncertainty
...
## 85. Causal Optimal Coupling for Gaussian Input-Output Distributional Data
...
## 86. Bias Inheritance in Neural-Symbolic Discovery of Constitutive Closures Under Function-Class Mismatch
...
## 87. UQ-SHRED: uncertainty quantification of shallow recurrent decoder networks for sparse sensing via engression
...
## 88. NeuroDDAF: Neural Dynamic Diffusion-Advection Fields with Evidential Fusion for Air Quality Forecasting
...
## 89. Policy Improvement Reinforcement Learning
...
## 90. MIRANDA: MId-feature RANk-adversarial Domain Adaptation toward climate change-robust ecological forecasting with deep learning
...
## 91. Full-Gradient Successor Feature Representations
...
## 92. Neural Ordinary Differential Equations for Modeling Socio-Economic Dynamics
...
## 93. OmniRoam: World Wandering via Long-Horizon Panoramic Video Generation
...
## 94. Video Models Reason Early: Exploiting Plan Commitment for Maze Solving
...
## 95. Scaling Video Pretraining for Surgical Foundation Models
...
**arXiv ID**: [2603.29966v2](http://arxiv.org/abs/2603.29966v2)

**PDF**: [下载链接](http://arxiv.org/pdf/2603.29966v2)
...
## 96. SurgTEMP: Temporal-Aware Surgical Video Question Answering with Text-guided Visual Memory for Laparoscopic Cholecystectomy
...
## 97. NeuroBRIDGE: Behavior-Conditioned Koopman Dynamics with Riemannian Alignment for Early Substance Use Initiation Prediction from Longitudinal Functional Connectome
...
## 98. EC-Bench: Enumeration and Counting Benchmark for Ultra-Long Videos
...
## 99. Gloria: Consistent Character Video Generation via Content Anchors
...
## 100. Collaborative AI Agents and Critics for Fault Detection and Cause Analysis in Network Telemetry
...
## 101. Hierarchical Apprenticeship Learning from Imperfect Demonstrations with Evolving Rewards
...
## 102. SafeDMPs: Integrating Formal Safety with DMPs for Adaptive HRI
...
## 103. GraSP-STL: A Graph-Based Framework for Zero-Shot Signal Temporal Logic Planning via Offline Goal-Conditioned Reinforcement Learning
...
## 104. CReF: Cross-modal and Recurrent Fusion for Depth-conditioned Humanoid Locomotion
...
## 105. PRISM: A Multi-View Multi-Capability Retail Video Dataset for Embodied Vision-Language Models
...
## 106. MambaVoiceCloning: Efficient and Expressive Text-to-Speech via State-Space Modeling and Diffusion Control
...
## 107. Epileptic Seizure Detection in Separate Frequency Bands Using Feature Analysis and Graph Convolutional Neural Network (GCN) from Electroencephalogram (EEG) Signals

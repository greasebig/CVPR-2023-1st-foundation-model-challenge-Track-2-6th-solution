...
## 87. Few-Shot Adaptation to Non-Stationary Environments via Latent Trend Embedding for Robotics
...
## 88. Multimodal Self-Attention Network with Temporal Alignment for Audio-Visual Emotion Recognition
...
## 89. V2A-DPO: Omni-Preference Optimization for Video-to-Audio Generation
...
## 90. D-SLAMSpoof: An Environment-Agnostic LiDAR Spoofing Attack using Dynamic Point Cloud Injection
...
## 91. ADMM-based Continuous Trajectory Optimization in Graphs of Convex Sets
...
## 92. STADA: Specification-based Testing for Autonomous Driving Agents
...
## 93. FutureVLA: Joint Visuomotor Prediction for Vision-Language-Action Model
...
## 94. Parallel-in-Time Nonlinear Optimal Control via GPU-native Sequential Convex Programming
...
## 95. Cybo-Waiter: A Physical Agentic Framework for Humanoid Whole-Body Locomotion-Manipulation
...
## 96. DepthCache: Depth-Guided Training-Free Visual Token Merging for Vision-Language-Action Model Inference
...
## 97. DiT4DiT: Jointly Modeling Video Dynamics and Actions for Generalizable Robot Control
...
## 98. Ensuring Safety in Automated Mechanical Ventilation through Offline Reinforcement Learning and Digital Twin Verification
...
## 99. Relaxed Efficient Acquisition of Context and Temporal Features
...
## 100. Single molecule localization microscopy challenge: a biologically inspired benchmark for long-sequence modeling
...
## 101. Factorized Neural Implicit DMD for Parametric Dynamics
...
## 102. Bio-Inspired Self-Supervised Learning for Wrist-worn IMU Signals
...
## 103. Surrogate models for nuclear fusion with parametric Shallow Recurrent Decoder Networks: applications to magnetohydrodynamics
...
## 104. Spatio-Temporal Attention Graph Neural Network: Explaining Causalities With Attention
...
## 105. Interventional Time Series Priors for Causal Foundation Models
...
## 106. Spatio-Temporal Forecasting of Retaining Wall Deformation: Mitigating Error Accumulation via Multi-Resolution ConvLSTM Stacking Ensemble
...
## 107. Data-Driven Integration Kernels for Interpretable Nonlocal Operator Learning
...
## 108. ID-LoRA: Identity-Driven Audio-Video Personalization with In-Context LoRA
...
## 109. OilSAM2: Memory-Augmented SAM2 for Scalable SAR Oil Spill Detection
...
## 110. FusionNet: a frame interpolation network for 4D heart models
...
## 111. Video-Based Reward Modeling for Computer-Use Agents
...
## 113. DISPLAY: Directable Human-Object Interaction Video Generation via Sparse Motion Guidance and Multi-Task Auxiliary
...
## 114. MA-EgoQA: Question Answering over Egocentric Videos from Multiple Embodied Agents
...
## 115. BrainSTR: Spatio-Temporal Contrastive Learning for Interpretable Dynamic Brain Network Modeling
...
## 116. ConfCtrl: Enabling Precise Camera Control in Video Diffusion via Confidence-Aware Interpolation
...
## 118. ENIGMA-360: An Ego-Exo Dataset for Human Behavior Understanding in Industrial Scenarios
...
## 119. FrameDiT: Diffusion Transformer with Frame-Level Matrix Attention for Efficient Video Generation
...
## 120. TemporalDoRA: Temporal PEFT for Robust Surgical Video Question Answering
...
## 121. The Generation-Recognition Asymmetry: Six Dimensions of a Fundamental Divide in Formal Language Theory
...
## 122. Memory-Guided View Refinement for Dynamic Human-in-the-loop EQA
...
## 123. TPIFM: A Task-Aware Model for Evaluating Perceptual Interaction Fluency in Remote AR Collaboration
...
## 124. TATIC: Task-Aware Temporal Learning for Human Intent Inference from Physical Corrections in Human-Robot Collaboration

**中文标题**: TATIC: Task-Aware Temporal Learning for Human Intent Inference from Physical Corrections in Human-Robot Collaboration

**作者**: Jiurun Song, Xiao Liang, Minghui Zheng

**发布日期**: 2026-03-10

**arXiv ID**: [2603.11077v1](http://arxiv.org/abs/2603.11077v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2603.11077v1)

**项目主页**: https://youtu.be/xF8A52qwEc8).
...
## 125. Perceptive Hierarchical-Task MPC for Sequential Mobile Manipulation in Unstructured Semi-Static Environments
...
## 126. AR-VLA: True Autoregressive Action Expert for Vision-Language-Action Models
...
## 127. TIMID: Time-Dependent Mistake Detection in Videos of Robot Executions
...
## 128. Beyond Short-Horizon: VQ-Memory for Robust Long-Horizon Manipulation in Non-Markovian Simulation Benchmarks
...
## 129. Vision-Augmented On-Track System Identification for Autonomous Racing via Attention-Based Priors and Iterative Neural Correction
...
## 130. SPAARS: Safer RL Policy Alignment through Abstract Exploration and Refined Exploitation of Action Space
...
## 131. Robust Spatiotemporal Motion Planning for Multi-Agent Autonomous Racing via Topological Gap Identification and Accelerated MPC
...
## 132. Hybrid Hidden Markov Model for Modeling Equity Excess Growth Rate Dynamics: A Discrete-State Approach with Jump-Diffusion
...
## 133. Task Aware Modulation Using Representation Learning for Upsaling of Terrestrial Carbon Fluxes

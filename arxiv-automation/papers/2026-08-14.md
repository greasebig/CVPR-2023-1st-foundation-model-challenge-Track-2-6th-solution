...
## 74. Dialogue-Aware Video-to-Music Generation Using Public Domain Film Collections
...
## 75. From Synthesis to Removal: Physics-Grounded Reflection Simulation and Diffusion-Based Video Dereflection
...
## 76. CT-$Δ$Bench: A Benchmark for Longitudinal 3D Medical Imaging Difference Reporting with Vision-Language Models
...
## 77. Governed Persistent Memory: Source-Bound State Semantics and Fail-Closed Release for Long-Horizon Agents
...
## 78. Redistribution-based Cost Inference Improves Sparse Safe Offline RL
...
## 79. Dual Spatial-Temporal Attribution: Architecture-Aligned Post-Hoc Explainability for Recurrent Graph Anomaly Detection
...
## 80. User-Assisted Collaborative Distributed Inference for Efficient QoS-Aware Autoscaling
...
## 81. The Sleeping Agent: What Gist-Based Context Compression Loses and Why
...
## 82. Robust and Efficient Noisy-Label Time-Series Classification via Dynamic Time Warping Based Granular Ball Computing
...
## 83. FM-LLM: A frequency-enhanced mixture-of-experts framework for adapting LLMs to time series forecasting
...
## 84. Foresight Without Seeing: Latent Futures for World Action Models
...
## 85. Keep the Future, Drop the Rollout: RIFT for World Action Models
...
**arXiv ID**: [2608.11521v2](http://arxiv.org/abs/2608.11521v2)

**PDF**: [下载链接](http://arxiv.org/pdf/2608.11521v2)
...
## 86. Enhancing Visual Domain Robustness in Behaviour Cloning via Saliency-Guided Augmentation
...
## 87. IoT-Enabled Autonomous Maritime Navigation in Smart Ports: A Curriculum-Guided Shared Policy Learning Framework
...
## 88. Excess Separability: Nuisance-Controlled Residual-Stream Probing for Benchmark Contamination Detection
...
## 89. Geometric and Behavioral Stratification in Transformer Residual Streams
...
## 90. Beyond Local Power: Functional Connectivity Analysis for Subject-Independent Learning Style Recognition
...
## 91. Latent variable models for simultaneous EOV identification and removal in population-based SHM
...
## 92. Disentangling the Expressivity of RoPE
...
## 93. JAPE: Joint Anomaly Prediction and Intrinsic Explanation in Multivariate Time Series
...
## 94. High-Order Liquid Evidence Encoding for Gradual GNSS Spoofing Detection in Autonomous Driving
...
## 95. Robust Multi-Tier Infant-Centered Audio Understanding with Whisper via Structured Speaker Conditioning
...
## 96. Certifying What Helps Customer-Return Timing: A Screen-and-Confirm Test for Conditioning Signals, and Why Decay Is Nearly Enough
...
## 97. Multi-Agent Target-Existence Verification and Learned Mask Geometry Refinement: Winning Report of the MeViS-Text Track at the 8th LSVOS Challenge 2026
...
## 98. Gloss-Free Representation Learning for Cross-Dataset Sign Spotting
...
## 99. Qwen-MusicAVQA-7B: A Multimodal Model for Music Audio-Visual QA
...
## 100. VidForensics-M1: Meta-Detection Reinforcement Learning with Verifiable Temporal Grounding for AI-Generated Video Forensics
...
## 101. SAR2Agri: Learning SAR Intensity Representations for Agricultural Monitoring
...
## 102. Static in Frames, Dynamic in Events: Rethinking Features in Event Cameras as Motion Cues
...
## 103. R4DSG: Relative 4D Scene Graph Memory for Object-Centric Question Answering in Long Egocentric Video
...
## 104. Watching Synthetic Videos: Aligning Cross-modal Representations with Visual Synthesis for Zero-shot Video Captioning
...
## 105. StreamFlow: Dynamic Memory Flows for Streaming Video Understanding
...
## 106. SafeCA: Safe Cross-Attention Localization and Regulation for Text-to-Video Jailbreak Defense
...
## 107. Temporally Grounded Compositional Camera Motion Understanding via Geometric Knowledge Distillation
...
## 108. Order Matters: LVLMs as Judges for Temporal Reasoning in Image Sequences
...
## 109. GESTO: Human-Centric Spatio-Temporal Memory for Reasoning in Dynamic Scenes
...
## 110. Multi-View Relational Distillation for Spatial Reasoning with Vision-Language Models
...
## 111. Evaluating Semantic and Spatial Guidance for Foundation Model Segmentation of Small-Scale PV in Remote Sensing Imagery
...
## 112. Compositional Benchmark Synthesis for Hierarchical Human Action Recognition
...
## 113. FADE: From Passive Verification to Active Discovery in Counterfactual Video Understanding
...
## 114. Beyond Pixels: From Video Priors to 4D Worlds
...
## 115. Ex-Omni-2D: Expressive Omni-Modal Dialogue Models with Native Visual Presence
...
## 116. BooST: Bridging Semantics and Motions for Efficient Skill Transfer
...
## 117. Predictive Allostatic Organization in Recurrent and Spiking Agents Under Partial Observability

**中文标题**: Predictive Allostatic Organization in Recurrent and Spiking Agents Under Partial Observability

**作者**: Frederick Hayes

**发布日期**: 2026-08-11

**arXiv ID**: [2608.11506v1](http://arxiv.org/abs/2608.11506v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2608.11506v1)
...
## 118. Variational Parameter Calibration with Physics-Aware Latent-Space Surrogates
...
## 119. ConVAWG: A Retrieval-Grounded Framework for Controlled Synthetic Dialogue Generation in Violence Against Women and Girls

...
## 57. A Unified Conditional Flow for Motion Generation, Editing, and Intra-Structural Retargeting
...
## 58. VibeFlow: Versatile Video Chroma-Lux Editing through Self-Supervised Learning
...
## 59. Geometric Routing Enables Causal Expert Control in Mixture of Experts
...
## 60. APEX-MEM: Agentic Semi-Structured Memory with Temporal Reasoning for Long-Term Conversational AI
...
## 61. Seeing Through Experts Eyes A Foundational Vision Language Model Trained on Radiologists Gaze and Reasoning
...
## 63. Towards Fine-grained Temporal Perception: Post-Training Large Audio-Language Models with Audio-Side Time Prompt
...
## 64. Representation over Routing: Overcoming Surrogate Hacking in Multi-Timescale PPO
...
## 65. Asymmetric-Loss-Guided Hybrid CNN-BiLSTM-Attention Model for Industrial RUL Prediction with Interpretable Failure Heatmaps
...
## 66. Outperforming Self-Attention Mechanisms in Solar Irradiance Forecasting via Physics-Guided Neural Networks
...
## 67. AVID: A Benchmark for Omni-Modal Audio-Visual Inconsistency Understanding via Agent-Driven Construction
...
## 68. CART: Context-Aware Terrain Adaptation using Temporal Sequence Selection for Legged Robots
...
## 69. Scouting By Reward: VLM-TO-IRL-Driven Player Selection For Esports
...
## 71. A Comparative Study of Dynamic Programming and Reinforcement Learning in Finite Horizon Dynamic Pricing
...
## 72. Parameter Importance is Not Static: Evolving Parameter Isolation for Supervised Fine-Tuning
...
## 73. Unsupervised Anomaly Detection in Process-Complex Industrial Time Series: A Real-World Case Study
...
## 74. Driving Engagement in Daily Fantasy Sports with a Scalable and Urgency-Aware Ranking Engine
...
## 75. Irregularly Sampled Time Series Interpolation for Binary Evolution Simulations Using Dynamic Time Warping
...
## 76. FAST: A Synergistic Framework of Attention and State-space Models for Spatiotemporal Traffic Prediction
...
## 77. AeTHERON: Autoregressive Topology-aware Heterogeneous Graph Operator Network for Fluid-Structure Interaction
...
## 78. SEDTalker: Emotion-Aware 3D Facial Animation Using Frame-Level Speech Emotion Diarization
...
## 79. Towards Successful Implementation of Automated Raveling Detection: Effects of Training Data Size, Illumination Difference, and Spatial Shift
...
## 80. The Spectrascapes Dataset: Street-view imagery beyond the visible captured using a mobile platform
...
**arXiv ID**: [2604.13315v2](http://arxiv.org/abs/2604.13315v2)

**PDF**: [下载链接](http://arxiv.org/pdf/2604.13315v2)
...
## 81. Explainable Fall Detection for Elderly Care via Temporally Stable SHAP in Skeleton-Based Human Activity Recognition
...
## 82. Lyra 2.0: Explorable Generative 3D Worlds
...
## 83. Generative Refinement Networks for Visual Synthesis
...
## 84. Distorted or Fabricated? A Survey on Hallucination in Video LLMs
...
## 85. Grasp in Gaussians: Fast Monocular Reconstruction of Dynamic Hand-Object Interactions
...
## 86. VideoFlexTok: Flexible-Length Coarse-to-Fine Video Tokenization
...
## 87. PianoFlow: Music-Aware Streaming Piano Motion Generation with Bimanual Coordination
...
## 88. DPC-VQA: Decoupling Quality Perception and Residual Calibration for Video Quality Assessment
...
## 89. Generative Anonymization in Event Streams
...
## 90. Cognition-Inspired Dual-Stream Semantic Enhancement for Vision-Based Dynamic Emotion Modeling
...
## 91. A Multi-Agent Feedback System for Detecting and Describing News Events in Satellite Imagery
...
## 92. ARGOS: Who, Where, and When in Agentic Multi-Camera Person Search
...
## 93. Hypergraph-State Collaborative Reasoning for Multi-Object Tracking
...
## 94. Relaxing Anchor-Frame Dominance for Mitigating Hallucinations in Video Large Language Models
...
## 95. Listening Alone, Understanding Together: Collaborative Context Recovery for Privacy-Aware AI
...
## 96. SpotSound: Enhancing Large Audio-Language Models with Fine-Grained Temporal Grounding
...
## 97. CoSyncDiT: Cognitive Synchronous Diffusion Transformer for Movie Dubbing
...
## 98. Robotic Manipulation is Vision-to-Geometry Mapping ($f(v) \rightarrow G$): Vision-Geometry Backbones over Language and Video Models
...
## 99. From Kinematics to Dynamics: Learning to Refine Hybrid Plans for Physically Feasible Execution
...
## 100. Anomaly Detection in IEC-61850 GOOSE Networks: Evaluating Unsupervised and Temporal Learning for Real-Time Intrusion Detection

**中文标题**: Anomaly Detection in IEC-61850 GOOSE Networks: Evaluating Unsupervised and Temporal Learning for Real-Time Intrusion Detection

**作者**: Joseph Moore

**发布日期**: 2026-04-14

**arXiv ID**: [2604.14233v1](http://arxiv.org/abs/2604.14233v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2604.14233v1)
...
## 101. Explainable Graph Neural Networks for Interbank Contagion Surveillance: A Regulatory-Aligned Framework for the U.S. Banking Sector

**中文标题**: Explainable Graph Neural Networks for Interbank Contagion Surveillance: A Regulatory-Aligned Framework for the U.S. Banking Sector

**作者**: Mohammad Nasir Uddin

**发布日期**: 2026-04-14

**arXiv ID**: [2604.14232v1](http://arxiv.org/abs/2604.14232v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2604.14232v1)
...
## 102. Causal Diffusion Models for Counterfactual Outcome Distributions in Longitudinal Data

...
## 66. A Fusion of context-aware based BanglaBERT and Two-Layer Stacked LSTM Framework for Multi-Label Cyberbullying Detection
...
## 67. Exploring Human Behavior During Abstract Rule Inference and Problem Solving with the Cognitive Abstraction and Reasoning Corpus
...
## 68. Structure and Redundancy in Large Language Models: A Spectral Study via Random Matrix Theory
...
## 69. Learning Rewards, Not Labels: Adversarial Inverse Reinforcement Learning for Machinery Fault Detection
...
## 70. Learning from Yesterday's Error: An Efficient Online Learning Method for Traffic Demand Prediction
...
## 71. Positional-aware Spatio-Temporal Network for Large-Scale Traffic Prediction
...
## 72. Humanizing Robot Gaze Shifts: A Framework for Natural Gaze Shifts in Humanoid Robots
...
## 73. Trajectory Generation with Endpoint Regulation and Momentum-Aware Dynamics for Visually Impaired Scenarios
...
## 74. DAGS-SLAM: Dynamic-Aware 3DGS SLAM via Spatiotemporal Motion Probability and Uncertainty-Aware Scheduling
...
## 75. Flow Matching is Adaptive to Manifold Structures
...
## 76. Outpatient Appointment Scheduling Optimization with a Genetic Algorithm Approach
...
## 77. Prior Knowledge-enhanced Spatio-temporal Epidemic Forecasting
...
## 78. WaveSSM: Multiscale State-Space Models for Non-stationary Signal Attention

...
## 48. CheXthought: A global multimodal dataset of clinical chain-of-thought reasoning and visual attention for chest X-ray interpretation
...
**arXiv ID**: [2604.26288v2](http://arxiv.org/abs/2604.26288v2)

**PDF**: [下载链接](http://arxiv.org/pdf/2604.26288v2)
...
## 49. Event-based Liveness Detection using Temporal Ocular Dynamics: An Exploratory Approach
...
## 50. DepthPilot: From Controllability to Interpretability in Colonoscopy Video Generation
...
## 51. HOI-aware Adaptive Network for Weakly-supervised Action Segmentation
...
## 52. ViBE: Visual-to-M/EEG Brain Encoding via Spatio-Temporal VAE and Distribution-Aligned Projection
...
## 53. Toward Personalized Digital Twins for Cognitive Decline Assessment: A Multimodal, Uncertainty-Aware Framework
...
## 54. Learning to Spend: Model Predictive Control for Budgeting under Non-Stationary Returns
...
## 55. Preserving Temporal Dynamics in Time Series Generation
...
## 56. Exploring the Potential of Probabilistic Transformer for Time Series Modeling: A Report on the ST-PT Framework
...
## 57. ATLAS: An Annotation Tool for Long-horizon Robotic Action Segmentation
...
## 58. STLGT: A Scalable Trace-Based Linear Graph Transformer for Tail Latency Prediction in Microservices
...
## 59. TimeMM: Time-as-Operator Spectral Filtering for Dynamic Multimodal Recommendation
...
## 60. Entropy-Dominated Temporal Vocal Dynamics as Digital Biomarkers for Depression Detection

**中文标题**: Entropy-Dominated Temporal Vocal Dynamics as Digital Biomarkers for Depression Detection

**作者**: Himadri S Samanta

**发布日期**: 2026-04-29

**arXiv ID**: [2604.26998v1](http://arxiv.org/abs/2604.26998v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2604.26998v1)

**类别**: q-bio.OT, cs.AI, cs.LG
...
## 61. STARRY: Spatial-Temporal Action-Centric World Modeling for Robotic Manipulation
...
## 62. Reactive Motion Generation via Phase-varying Neural Potential Functions
...
## 63. Probabilistic data quality assessment for structural monitoring data via outlier-resistant conditional diffusion model
...
## 64. Recurrence-Based Nonlinear Vocal Dynamics as Digital Biomarkers for Depression Detection from Conversational Speech
...
## 65. Evaluating the Alignment Between GeoAI Explanations and Domain Knowledge in Satellite-Based Flood Mapping
...
## 66. Report of the 5th PVUW Challenge: Towards More Diverse Modalities in Pixel-Level Understanding
...
## 67. Mutual Forcing: Dual-Mode Self-Evolution for Fast Autoregressive Audio-Video Character Generation
...
## 68. Exploring Remote Photoplethysmography for Neonatal Pain Detection from Facial Videos
...
## 69. Vision SmolMamba: Spike-Guided Token Pruning for Energy-Efficient Spiking State-Space Vision Models
...
## 70. A Systematic Post-Train Framework for Video Generation
...
## 71. HuM-Eval: A Coarse-to-Fine Framework for Human-Centric Video Evaluation
...
## 72. Rapid tracking through strongly scattering media with physics-informed neuromorphic speckle analysis
...
## 73. OmniVTG: A Large-Scale Dataset and Training Paradigm for Open-World Video Temporal Grounding
...
## 74. Entropy Centroids as Intrinsic Rewards for Test-Time Scaling
...
## 75. Momentum-Conserving Graph Neural Networks for Deformable Objects
...
## 76. MarkIt: Training-Free Visual Markers for Precise Video Temporal Grounding
...
## 77. Monitoring Neural Training with Topology: A Footprint-Predictable Collapse Index

**中文标题**: Monitoring Neural Training with Topology: A Footprint-Predictable Collapse Index

**作者**: Alexander Kalinowski

**发布日期**: 2026-04-28

**arXiv ID**: [2604.26984v1](http://arxiv.org/abs/2604.26984v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2604.26984v1)
...
## 78. Learning Neural Operator Surrogates for the Black Hole Accretion Code

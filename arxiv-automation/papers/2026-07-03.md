...
## 75. VideoSearch-R1: Iterative Video Retrieval and Reasoning via Soft Query Refinement
...
## 76. MindAU: EEG-Conditioned Facial Action Unit Editing via Dual-Stream Manifold Alignment
...
## 77. RetailSMV: Exocentric vs. Egocentric Adaptation of Foundation Video World Models in Retail
...
## 78. Learning When to Listen: Gated Affect Fusion for Human Motion Prediction
...
## 79. OnPoint: Offline-to-Online Multi-Level Distillation for Point-Supervised Online Temporal Action Localization
...
## 80. Grounded Optimization: A Layered Engineering Framework for Reducing LLM Hallucination in Automated Personal Document Rewriting
...
## 81. From World Models to World Action Models: A Concise Tutorial for Robotics
...
## 82. Detecting the Undetectable: Enhancing Unsupervised time series Anomaly Detection via Active Learning
...
## 83. Domain Knowledge Based Temporal-Spatial Graph Convolution Network for ECG Recognition
...
## 84. CommonRoad-Game: A Human-in-the-Loop Simulation Framework for Autonomous Driving
...
## 85. The Three Dimensions of ROS 2 Middleware
...
## 86. AutoSpeed: Annotation-Free Stage-Adaptive Motion Speed Learning for Robot Manipulation
...
## 87. From Real-Time Planning to Reliable Execution:Scalable Coordination for Heterogeneous Multi-Robot Fleets in Industrial Environments
...
## 88. Learning from Demonstration via Spatiotemporal Tubes for Unknown Euler-Lagrange Systems
...
## 89. Search-Based Spatiotemporal and Multi-Robot Motion Planning on Graphs of Space-Time Convex Sets
...
## 90. Learning Gait-Aware Quadruped Locomotion with Temporal Logic Specifications
...
## 91. When Context Compensates for Sparse Event History: AlphaEarth for Spatio-Temporal Point-Process Forecasting
...
## 92. Seahorse: A Unified Benchmarking Framework for Spatiotemporal Event Modeling
...
## 93. From Pixels to Temporal Correlations: Learning Informative Representations for Reinforcement Learning Pre-training
...
## 94. Local Motion Matters: A Deconstruct-Recompose Paradigm for Reinforcement Learning Pre-training from Videos
...
## 95. How Environment and Urbanization Shape Bird Diversity in Sri Lanka
...
## 96. I\textsuperscript{2}RiMA: Spectral Riemannian Representation with Temporal Attention for Mental Stress Detection based on EEG Signals
...
## 97. Gauging, Measuring, and Controlling Critic Complexity in Actor-Critic Reinforcement Learning
...
## 98. Timesynth: A Temporal Fidelity Framework for Health Signal Digital Twins
...
## 99. PRISM: Prioritized Channel Importance with Semi-supervised Domain Adaptation for Cross-Subject EEG Emotion Recognition
...
## 100. PRISM-VO: Scale-Aware Visual Odometry Using Photometric Plenoptic Bundle Adjustment
...
## 101. Progressive Pose-Guided 4D Animal Reconstruction from Monocular Video
...
## 102. SwiftAudio: Data-Efficient Caption-Only Distillation for One-Step Text-to-Audio Diffusion-based Generation
...
## 103. A First Exploration of Neuromorphic OT-CFM for Multi-Speaker VSR
...
## 105. DVG-WM: Disentangled Video Generation Enables Efficient Embodied World Model for Robotic Manipulation
...
**arXiv ID**: [2606.32028v2](http://arxiv.org/abs/2606.32028v2)

**PDF**: [下载链接](http://arxiv.org/pdf/2606.32028v2)
...
## 106. HABIT: Human-Aware Behavior and Interaction Training Dataset for Robot Manipulation
...
## 107. ChronoFlow-Policy: Unifying Past-Current-Future Interaction Flow in Visuomotor Policy Learning
...
## 108. Diffusion-based 4D Trajectory Prediction and Distributed Control for UAV Swarms
...
## 109. MIRTH: Mutual-Information Reasoning with Temporal Hubs for Vision-Language-Action Agents
...
## 110. Computer vision-based neural networks for radioisotope identification in urban environments
...
## 111. Device Passport: Enabling Spatio-Temporal Pretrained Models to Generalize Across Input Layouts

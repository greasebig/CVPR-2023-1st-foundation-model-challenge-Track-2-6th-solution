# arXiv Papers - 2026-04-25

**更新时间**: 2026-04-25 04:26:41
...
## 51. Agentic AI for Personalized Physiotherapy: A Multi-Agent Framework for Generative Video Training and Real-Time Pose Correction
...
## 53. StormNet: Improving storm surge predictions with a GNN-based spatio-temporal offset forecasting model
...
## 54. CHORUS: An Agentic Framework for Generating Realistic Deliberation Data
...
## 55. AI models of unstable flow exhibit hallucination
...
## 56. Seeing Further and Wider: Joint Spatio-Temporal Enlargement for Micro-Video Popularity Prediction
...
## 57. Physics-Enhanced Deep Learning for Proactive Thermal Runaway Forecasting in Li-Ion Batteries
...
## 58. Visual-Tactile Peg-in-Hole Assembly Learning from Peg-out-of-Hole Disassembly
...
## 59. Occupancy Reward Shaping: Improving Credit Assignment for Offline Goal-Conditioned Reinforcement Learning
...
## 60. Temporal Difference Calibration in Sequential Tasks: Application to Vision-Language-Action Models
...
## 61. Lexicographic Minimum-Violation Motion Planning using Signal Temporal Logic
...
## 62. AdaTracker: Learning Adaptive In-Context Policy for Cross-Embodiment Active Visual Tracking
...
## 63. Stochastic Barrier Certificates in the Presence of Dynamic Obstacles
...
## 64. climt-paraformer: Stable Emulation of Convective Parameterization using a Temporal Memory-aware Transformer
...
## 65. Early Detection of Latent Microstructure Regimes in Limit Order Books
...
## 66. Physics-Conditioned Synthesis of Internal Ice-Layer Thickness for Incomplete Layer Traces
...
## 67. Self-Aware Vector Embeddings for Retrieval-Augmented Generation: A Neuroscience-Inspired Framework for Temporal, Confidence-Weighted, and Relational Knowledge
...
## 68. Sink-Token-Aware Pruning for Fine-Grained Video Understanding in Efficient Video LLMs
...
## 69. Explicit Dropout: Deterministic Regularization for Transformer Architectures
...
## 70. Robustness of Spatio-temporal Graph Neural Networks for Fault Location in Partially Observable Distribution Grids
...
## 71. Causal-Transformer with Adaptive Mutation-Locking for Early Prediction of Acute Kidney Injury
...
## 72. Clinically Interpretable Sepsis Early Warning via LLM-Guided Simulation of Temporal Physiological Dynamics
...
## 73. ACT: Anti-Crosstalk Learning for Cross-Sectional Stock Ranking via Temporal Disentanglement and Structural Purification

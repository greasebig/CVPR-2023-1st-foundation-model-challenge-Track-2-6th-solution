...
## 64. Adaptive Multi-Agent Feature Selection for Personalized Fall Risk Prevention
...
## 65. The Road Taken: The Role of Optimizers at the Edge of Stability
...
## 66. QuARC-GS: Quantized Anchored Residual Coding for Compact Dynamic Scene Streaming with Gaussian Splatting
...
## 67. Primitive Representation Learning for Unsupervised Dynamic Contrast Enhanced MRI Reconstruction
...
## 68. AViTS: Adaptive Spatiotemporal Token Selection for Efficient Dynamic-Resolution Generation
...
## 69. LinCa: Accelerating Diffusion Models via Learnable Decomposed Feature Caching
...
## 70. Beyond Instrument Motion: Recognizing Tissue Tension Toward Surgical Skill Assessment
...
## 71. CFB-GBM v2.0: An Augmented Longitudinal Dataset for Multi-Modal Glioblastoma Segmentation, Radiomics, and RANO Progression Tracking
...
## 72. ETHEREAL: A 25.6-$μ$s/inf. Low-latency Event-driven Graph-neural-network Processor for High-resolution Vision at the Edge
...
## 73. DynaForcing: Overcoming Dynamic Collapse in Self-Forcing Distillation for Streaming Avatar Generation
...
## 74. Monitoring Pasture Restoration from Satellite Image Time Series: Caveats and Opportunities
...
## 75. Magnitude-Direction Decoupling for Fast Video Generation with Flow Matching Models
...
## 76. CoinVE-200K: A Large-Scale High-Quality Dataset for Compositional Instruction-Guided Video Editing
...
## 77. MSEditor: Toward Consistent Multi-Shot Video Editing
...
## 78. Looking Beyond the Scale: Do Surgical Skill Models Learn Transferable Representations Across Assessment Rubrics?
...
## 79. NeuroPath: Brain-Inspired Dual-Pathway Graph Convolutional Networks for Skeleton-Based Action Recognition
...
## 80. Counterfactual Anatomy-guided Spatial-Temporal Decoding for Annotation-Free Hallucination Mitigation in Medical VLMs
...
## 81. SemComp-Bench: Benchmarking Semantic Task Completion in Video Generation
...
## 82. TF-CADE: Foreground-Concentrated Text-Video Alignment for Zero-Shot Temporal Action Detection
...
## 83. TEAMS: Text-prompted spatiotEmporal dual-heAd Mamba Snake
...
## 84. SPVC: Structured and Panoptic Video Fixing for Cross-Dataset Driving Scene Rendering
...
## 85. Spectral Gradient Orthogonalization Improves Differentially Private Training at Scale
...
## 86. MoE-ViE: Mixture of Experts Vision Encoder for Efficient Image and Video Understanding
...
## 87. Noisy group neurons with synchronous resetting for high-performance spiking neural networks
...
## 88. Learning latent progression states from spatial heterogeneity in uterine histopathology
...
## 89. Against Political Polarization: A Unified Framework for Tracing Evolving Political Ideologies on Social Media
...
## 90. MotoSafety: Edge-AI with Learned Temporal Importance for Two-Wheeler Collision Risk Assessment Under Time Pressure
...
## 91. Physics-Informed Sliding-Window Particle Filtering for Tactile-Only In-Hand 6-DoF Object Pose Refinement
...
## 92. Embodied-Navigator: Point, Think, Memorize, and Align for Efficient Navigation
...
## 93. When Does Dynamic Ensembling Pay Off? Diagnosing Regionwise Gains in Regression under Distribution Shift
...
## 94. Global Crises and National Policies: A Large Scale Analysis of Political Content in German Language Online Media
...
## 95. Classifying Directional Trajectories Near Criticality in the Three-State Majority-Vote Model with Deep Belief Networks and Bidirectional GRUs
...
## 96. Evaluating and improving crop-yield forecasting methods during extreme drought
...
## 97. Diff-DDoS: Realistic Cyber-Physical Attack Synthesis and Robust Detection for 5G-Enabled CPS Using Tabular Diffusion Models
...
## 98. MAGPIE-Net: Predicting short-duration heavy-rainfall events in station neighborhoods from multitemporal FY-4A AGRI observations

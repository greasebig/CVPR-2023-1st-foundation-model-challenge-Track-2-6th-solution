# arXiv Papers - 2026-08-01

**更新时间**: 2026-08-01 05:14:45
...
## 56. Latent States in Neural Networks: Recovering the Temporal Structure of Drifting Data from Model Weights
...
## 57. Bridging Inference-Time Scaling and Episodic Memory with Action-Centric Graphs
...
## 58. PIE-APT: A Unified Framework for Temporal Planning and Contradiction Hunting via Incremental Direct-Derivation Abduction
...
## 59. From Passive Video to Editable Experience: Physically Grounded Experience Synthesis for Embodied Intelligence
...
## 60. UrbanDS: A Graph-Guided LLM Multi-Agent System for Data-Intensive Urban Tasks
...
## 61. MPEcho: A Melody and Phoneme-Aware Generative Framework for Controllable Cover Song Generation
...
## 62. SKY-Piano: A Multimodal Piano Performance Dataset
...
## 63. Temporally Centered SIGReg Improves Multi-Task LeWorldModel Learning: From Analysis to Method
...
## 64. Vision-TL-Action: Neuro-Symbolic Trajectory Generation from Visual Observations and Temporal Logic
...
## 65. Compression-Based Behavioral Similarity for Open-World Sybil Discovery on Ethereum
...
## 66. ZUNA1.1: A more flexible EEG foundation model for Denoising and Super-resolution
...
## 67. Skillful forecasting of offshore winds from satellite scatterometer constellations
...
## 68. THGFM: Dual-Branch Temporal Heterogeneous Graph Fusion Model
...
## 69. Hierarchical Spatio-Temporal Transformer for Coherent Emergency Department Forecasting
...
## 70. Single-Beat Cuffless Blood Pressure Estimation Using Ear-PPG and ECG with a Lightweight Hybrid Learning Framework
...
## 71. Expected Survival-Time Bounds for Robust Optimization Over Time under Isotropic Gaussian Dynamics
...
## 72. Rethinking EEG-Based Disease Diagnosis: Decoupling Instance Representation Learning from Subject-Level Supervision
...
## 73. Forecasting Trajectory-Level Safety Risks in Black-Box Multi-Turn Interactions
...
## 74. PowerAtlas: Towards Electricity-Computing Co-Scheduling for Power Systems
...
## 75. DoTime: A Synthetic Benchmark Generator for Interventional and Counterfactual Time Series
...
## 76. Collaborative Weighting with Pessimistic Critic for Mitigating Overestimation in Off-Policy Reinforcement Learning

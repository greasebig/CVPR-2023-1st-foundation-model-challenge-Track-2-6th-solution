...
## 66. SelfLift: Accelerating Few-Step Diffusion via Self-Recovering Resolution Transition
...
## 67. Who Drives the Probability Game of VLMs? A Temporal Causal Drive Evaluation Framework
...
## 68. Towards Trustworthy Autonomous Robots: An Explainable AI-Based Decision Framework
...
## 69. DeepAffinity: Long-Term Aspect Preference Prediction in eCommerce using Small Language Models
...
## 70. FUSE: An Evaluating Framework for Dangerous Capabilities of LLMs
...
## 71. C$^{3}$T: Counterfactual Causal Reasoning for Sentiment Shifts in Social-Media Conversation Trees
...
## 72. Latent Cluster Analysis for Vision-Language-Action Models
...
## 74. TRACE: Spatiotemporal Contact Memory Graph Network Simulator for Granular Dynamics
...
## 75. Prototype-guided transfer of sparse literature knowledge for electrolyte additive discovery
...
## 76. Statistical Feature Augmentation for Anomaly Detection in Dynamic Graphs
...
## 77. Learning the Constitutive Behavior of Materials via Neural Operators and Causal Attention: Case Studies in Plasticity and Damage
...
## 78. A Computational Comparison of Fourier Spectral Differentiation and Spatial Automatic Differentiation in Periodic Physics-Informed Neural Networks
...
## 79. Act More, Decide Less: Skill-Guided Adaptive Action Chunking for Long-Horizon LLM Agents
...
## 80. A Unified Particle Filter LSTM for Data-Driven Process Simulation
...
## 81. Learning with Volterra Neural Networks: A System Theoretic Perspective
...
## 82. Kirin: Animal Motion Generation from In-the-Wild Video
...
## 83. Video2Reaction: Training Foundation Video Models to Predict Audience Reaction
...
## 84. DESA-TTA: Dynamic EMA and Source Anchoring for Test-Time Adaptation
...
## 85. Allocate Before You Embed: Adaptive Visual Input Allocation for Video Embeddings
...
## 86. Evidential Deep Learning for Multi-Modal Anti-UAV Detection
...
## 87. From Visual Cues to Spoken Narration: Rethinking Audio Description
...
## 88. H3-World: Turning Language Understanding into World Control
...
## 89. What, Where, and How: Probing Spatiotemporal Representations in Video Foundation Models
...
## 90. TempCloze: Can Video-LLMs Identify the Missing Middle?
...
## 91. CameraEditor: Camera-Controlled Image Editing via Video-Prior Sequential Modeling
...
## 92. TimeSteer: Inference-Time Speech Scheduling in Joint Audio-Visual Diffusion Models
...
## 93. Seeing the World and the Self from Egocentric Video
...
## 94. MeRoPE: Metric Rotary Position Embedding for Camera-Controlled Video Generation
...
## 95. Accurate in space, unreliable in time: how LLMs represent national cultural change
...
## 96. OutageDiT: A Generative Foundation Model for Power Outage Forecasting and Scenario Simulation
...
## 97. Does Imitation Learning Preserve Temporal Robustness in Dexterous Manipulation? An Expert-Learner Comparison Across Task Execution Speeds
...
## 98. HitMem: Hierarchical Temporal 3D Memory with Multi-Modal Context-Aware Retrieval for Dynamic Environments
...
## 99. Basin Geometry and Reliable Recall of Dynamical Memories in Reservoir Computing
...
## 100. A Study of Conditional Diffusion Models for Open-Loop Control under Dry Friction and Stiction
...
## 101. Hearing the Whispers: Black-Box Membership Inference Attacks on Finetuned TTS Models

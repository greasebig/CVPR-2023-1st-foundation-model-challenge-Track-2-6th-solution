...
## 86. Train-Small Deploy-Large: Leveraging Diffusion-Based Multi-Robot Planning
...
## 87. Predicting Activity Cliffs for Autonomous Medicinal Chemistry
...
## 88. Measurement of Generative AI Workload Power Profiles for Whole-Facility Data Center Infrastructure Planning
...
## 89. Tracking Adaptation Time: Metrics for Temporal Distribution Shift
...
## 90. Amortized Filtering and Smoothing with Conditional Normalizing Flows
...
## 91. SBBTS: A Unified Schrödinger-Bass Framework for Synthetic Financial Time Series
...
## 92. Multi-Turn Reasoning LLMs for Task Offloading in Mobile Edge Computing
...
## 93. Accelerating Training of Autoregressive Video Generation Models via Local Optimization with Representation Continuity
...
## 94. STQuant: Spatio-Temporal Adaptive Framework for Optimizer Quantization in Large Multimodal Model Training
...
## 95. SHIELD: A Segmented Hierarchical Memory Architecture for Energy-Efficient LLM Inference on Edge NPUs
...
## 96. Bi-level Heterogeneous Learning for Time Series Foundation Models: A Federated Learning Approach
...
## 97. CASE: Cadence-Aware Set Encoding for Large-Scale Next Basket Repurchase Recommendation
...
## 98. DSPR: Dual-Stream Physics-Residual Networks for Trustworthy Industrial Time Series Forecasting
...
## 99. PD-SOVNet: A Physics-Driven Second-Order Vibration Operator Network for Estimating Wheel Polygonal Roughness from Axle-Box Vibrations
...
## 100. When Does Context Help? A Systematic Study of Target-Conditional Molecular Property Prediction
...
## 101. Hybrid ResNet-1D-BiGRU with Multi-Head Attention for Cyberattack Detection in Industrial IoT Environments
...
## 102. Evolution of Video Generative Foundations
...
## 103. Action Images: End-to-End Policy Learning via Multiview Video Generation
...
## 104. DiffHDR: Re-Exposing LDR Videos with Video Diffusion Models
...
## 105. CodecSight: Leveraging Video Codec Signals for Efficient Streaming VLM Inference

**中文标题**: CodecSight: Leveraging Video Codec Signals for Efficient Streaming VLM Inference

**作者**: Yulin Zou, Yan Chen, Wenyan Chen, JooYoung Park, Shivaraman Nitin et al.

**发布日期**: 2026-04-07

**arXiv ID**: [2604.06036v3](http://arxiv.org/abs/2604.06036v3)

**PDF**: [下载链接](http://arxiv.org/pdf/2604.06036v3)
...
## 106. OmniCamera: A Unified Framework for Multi-task Video Generation with Arbitrary Camera Control
...
## 107. HumANDiff: Articulated Noise Diffusion for Motion-Consistent Human Video Generation
...
## 108. Mixture-of-Modality-Experts with Holistic Token Learning for Fine-Grained Multimodal Visual Analytics in Driver Action Recognition
...
## 109. BiCoord: A Bimanual Manipulation Benchmark towards Long-Horizon Spatial-Temporal Coordination
...
## 110. Referring-Aware Visuomotor Policy Learning for Closed-Loop Manipulation
...
## 111. CoEnv: Driving Embodied Multi-Agent Collaboration via Compositional Environment
...
## 112. Synergizing Efficiency and Reliability for Continuous Mobile Manipulation

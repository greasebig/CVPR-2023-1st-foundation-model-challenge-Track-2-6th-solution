...
## 61. SMART: MLLM-guided Temporal Alignment for Unifying Sign Language Recognition and Spotting
...
## 62. 4DStreamCtrl: Interactive Video Generation with Online 4D Control
...
**arXiv ID**: [2608.25479v2](http://arxiv.org/abs/2608.25479v2)

**PDF**: [下载链接](http://arxiv.org/pdf/2608.25479v2)
...
## 63. VGA-BenchV2: An Expanded Unified Benchmark and Multi-Model Framework for Evaluating Video Aesthetics and Generation Quality
...
## 64. Bootstrapping a 4D LiDAR Annotation Tool from Video Foundation Models
...
## 65. Where to Look Matters: On-Policy Self-Distillation for Long-Video Understanding
...
## 66. CoRE: Weakly Supervised Coarse-to-Fine Risk Evidence Learning in Driving Videos
...
## 67. Planetary Prediction Engine: Autonomous Geospatial Prediction via Intelligent Data Selection and Foundation Model Embeddings
...
## 68. Formal, Executable and Explainable Runtime Monitoring of Spoken Air Traffic Control Operational Procedures
...
## 69. Choose Your Game Wisely: Measuring Game-Theoretic Structures in Real-World Vehicle Interactions
...
## 70. Towards A Unified Information Bottleneck Framework for Time Series Explanations
...
## 71. LocalLSTC: A Long Short-Term Control Architecture for Locally Deployed GUI Agents
...
## 72. Reconstructing the Right Episode: Evaluating Interleaved Conversational Memory Beyond Long Context
...
## 73. LDAC-Net: A Learnable Multi-Lag Differencing Attention-Convolution Network for Drift-Robust Recognition with Low-Cost MOX Gas Sensors
...
## 74. PolyMemDB: A Polyglot Database System for AI Memory Management
...
## 75. ConfAL-WM: Confidence-Guided Active Learning for Action-Conditioned World Models
...
## 76. When Stale Constraints Go Unchecked: Budgeted Verification Failures in Inherited Agent Memory
...
## 77. Learning Continuous Regional Temperature Fields with Lead-Time and Resolution Queries
...
## 78. WALL-SS: Scaling Long-horizon World Models via Next-Scale Autoregression
...
## 79. One Policy, Many Embodiments: Unified Camera-Centric Action Geometry Pre-training for Heterogeneous Embodied Manipulation
...
## 80. TacForcing: Streaming Action Generation with Execution-Time Tactile Feedback
...
## 81. PRISM: Projection-Integrated Sampling-Based MPC with Bayesian Cost Tuning for Bimanual Manipulation
...
## 82. Advantage-Driven Explicit Memory for Social Navigation
...
## 83. NeoTriFuse: Reliability-Aware Multimodal Fusion under Missingness Heterogeneity for Neonatal Mortality Risk Prediction
...
## 84. Beyond Capability Benchmarks: Learning Operational Fingerprints of LLM Cloud Services from Production Incident Metadata
...
## 85. A causal graph-informed temporal convolution architecture for interpretable retail electricity price forecasting
...
## 86. Quantum-Inspired Modeling of Driving Behavior
...
## 87. Scalable Multi-GPU Simulation of 3D Multicellular Growth with RNN-Based Workload Balancing
...
## 88. Drift-Aware Multimodal User Representation Learning via Multi-Scale Temporal Modeling and Sparse Mixture-of-Experts
...
## 89. Tropospheric temperature and humidity profile retrieval from Meteosat Flexible Combined Imager based on deep learning
...
## 90. Modeling spatio-temporal locality in multi-step forecasting of geo-referenced time series
...
## 91. TRACE: Retrospective Streaming Generation of Physical Fields under Sparse Structured Sensing
...
## 92. A Multi-View Coupled Tensor Decomposition for Lightweight Online Adaptive Traffic Prediction
...
## 93. Lightweight Machine Learning-Driven Monocular Sidewalk Path Extraction for Embedded Micromobility Navigation
...
## 94. What Do Audio-Visual Synchronization Metrics Actually Measure?
...
## 95. From Seeing to Acting: Smart Glasses as First-Person Intelligence Platforms
...
## 96. GameWAM: A World Action Model for Video Games

**中文标题**: GameWAM: A World Action Model for Video Games

**作者**: Yuncheng Guo, Zhanqiu Zhang, Yiwen Guo, Weijia Li

**发布日期**: 2026-08-25

**arXiv ID**: [2608.26200v1](http://arxiv.org/abs/2608.26200v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2608.26200v1)
...
## 97. MoTE: Mixture of Task Experts for Multi-Task Video Understanding
...
## 98. Deep Learning Super Resolution for Satellite Cloud Mask Downscaling
...
## 99. Game2World Engine: Unlocking In-the-Wild Gameplay Videos for World Model Training
...
## 100. TurboT2VA: Fast Large-Scale Text-to-Video-Audio Generation via Score-Regularized Consistency Distillation
...
## 101. KLTNet: Learning Sparse Feature Tracking for Robust and Accurate Monocular Visual-Inertial Odometry
...
## 102. When Does Context Routing Help? A Systematic Study of Multi-Modal Fusion in Time Series Forecasting
...
## 103. NVExplain: Explaining Time Series Forecasting with Latent Trajectory Analysis and Structure-Preserving Surrogates
...
## 104. DeMMO: Longitudinal and Cross-Disease Modelling of Digital Mobility Outcomes via Multi-Task Learning
...
## 105. TrustFormer: Cross-Temporal and Cross- Dimensional Transformer for Task-Specific Multi-Dimensional Trust Evaluation
...
## 106. Multi-View Trust Evaluation for Collaborator Selection via Evidential Deep Learning
...
## 107. Long-Term Behavioral Evaluation for Trusted Collaborator Selection via Bidirectional Mamba
...
## 108. What Should a Large Language Model See? Physical Invariants as a Data Representation for PDE Discovery

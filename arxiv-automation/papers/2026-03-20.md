...
## 77. Recurrent Reasoning with Vision-Language Models for Estimating Long-Horizon Embodied Task Progress
...
## 78. Symphony: A Cognitively-Inspired Multi-Agent System for Long-Video Understanding
...
## 79. 3D MRI-Based Alzheimer's Disease Classification Using Multi-Modal 3D CNN with Leakage-Aware Subject-Level Evaluation
...
## 80. S3T-Former: A Purely Spike-Driven State-Space Topology Transformer for Skeleton Action Recognition

**中文标题**: S3T-Former: A Purely Spike-Driven State-Space Topology Transformer for Skeleton Action Recognition

**作者**: Naichuan Zheng, Hailun Xia, Zepeng Sun, Weiyi Li, Yujia Wang

**发布日期**: 2026-03-18

**arXiv ID**: [2603.18062v1](http://arxiv.org/abs/2603.18062v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2603.18062v1)
...
## 81. ConfusionBench: An Expert-Validated Benchmark for Confusion Recognition and Localization in Educational Videos
...
## 82. GigaWorld-Policy: An Efficient Action-Centered World--Action Model
...
## 83. From Noise to Signal: When Outliers Seed New Topics
...
## 84. Gradient-Informed Temporal Sampling Improves Rollout Accuracy in PDE Surrogate Training
...
## 85. Specification-Aware Distribution Shaping for Robotics Foundation Models
...
## 86. Mitigating LLM Hallucinations through Domain-Grounded Tiered Retrieval
...
## 87. EVA: Aligning Video World Models with Executable Robot Actions via Inverse Dynamics Rewards
...
## 88. Machine Learning for Network Attacks Classification and Statistical Evaluation of Machine Learning for Network Attacks Classification and Adversarial Learning Methodologies for Synthetic Data Generation
...
## 89. Uncovering Latent Phase Structures and Branching Logic in Locomotion Policies: A Case Study on HalfCheetah
...
## 90. Baguan-TS: A Sequence-Native In-Context Learning Model for Time Series Forecasting with Covariates
...
## 91. TimeAPN: Adaptive Amplitude-Phase Non-Stationarity Normalization for Time Series Forecasting
...
## 92. The Phasor Transformer: Resolving Attention Bottlenecks on the Unit Circle
...
## 93. Public Profile Matters: A Scalable Integrated Approach to Recommend Citations in the Wild
...
## 94. RoboForge: Physically Optimized Text-guided Whole-Body Locomotion for Humanoids
...
## 95. REAL: Robust Extreme Agility via Spatio-Temporal Policy Learning and Physics-Guided Filtering
...
## 96. Real-Time Online Learning for Model Predictive Control using a Spatio-Temporal Gaussian Process Approximation
...
## 97. FloorPlan-VLN: A New Paradigm for Floor Plan Guided Vision-Language Navigation
...
## 98. SafeLand: Safe Autonomous Landing in Unknown Environments with Bayesian Semantic Mapping
...
## 99. Physics-informed Deep Mixture-of-Koopmans Vehicle Dynamics Model with Dual-branch Encoder for Distributed Electric-drive Trucks
...
## 100. AGRI-Fidelity: Evaluating the Reliability of Listenable Explanations for Poultry Disease Detection
...
## 101. RHYME-XT: A Neural Operator for Spatiotemporal Control Systems
...
## 102. Federated Distributional Reinforcement Learning with Distributional Critic Regularization
...
## 103. Modeling Overlapped Speech with Shuffles
...
## 104. BoundAD: Boundary-Aware Negative Generation for Time Series Anomaly Detection
...
## 105. Atomic Trajectory Modeling with State Space Models for Biomolecular Dynamics
...
## 106. End-to-end data-driven prediction of urban airflow and pollutant dispersion
...
## 107. Conditional Inverse Learning of Time-Varying Reproduction Numbers Inference
...
## 108. Translation Invariance of Neural Operators for the FitzHugh-Nagumo Model
...
## 109. Large-Scale 3D Ground-Motion Synthesis with Physics-Inspired Latent Operator Flow Matching
...
## 110. Patient4D: Temporally Consistent Patient Body Mesh Recovery from Monocular Operating Room Video
...
## 111. A Lensless Polarization Camera
...
## 112. MosaicMem: Hybrid Spatial Memory for Controllable Video World Models
...
## 113. Edge-Efficient Two-Stream Multimodal Architecture for Non-Intrusive Bathroom Fall Detection
...
## 114. TrackDeform3D: Markerless and Autonomous 3D Keypoint Tracking and Dataset Collection for Deformable Objects
...
## 115. Astrolabe: Steering Forward-Process Reinforcement Learning for Distilled Autoregressive Video Models
...
## 116. HopChain: Multi-Hop Data Synthesis for Generalizable Vision-Language Reasoning
...
**arXiv ID**: [2603.17024v2](http://arxiv.org/abs/2603.17024v2)

**PDF**: [下载链接](http://arxiv.org/pdf/2603.17024v2)
...
## 117. WorldCam: Interactive Autoregressive 3D Gaming Worlds with Camera Pose as a Unifying Geometric Representation
...
## 118. Demystifing Video Reasoning
...
## 119. SparkVSR: Interactive Video Super-Resolution via Sparse Keyframe Propagation
...
## 120. CineSRD: Leveraging Visual, Acoustic, and Linguistic Cues for Open-World Visual Media Speaker Diarization
...
## 121. Shielded Reinforcement Learning Under Dynamic Temporal Logic Constraints
...
## 122. DreamPlan: Efficient Reinforcement Fine-Tuning of Vision-Language Planners via Video World Models
...
## 123. Kinema4D: Kinematic 4D World Modeling for Spatiotemporal Embodied Simulation
...
## 124. OGScene3D: Incremental Open-Vocabulary 3D Gaussian Scene Graph Mapping for Scene Understanding
...
## 125. PA-LVIO: Real-Time LiDAR-Visual-Inertial Odometry and Mapping with Pose-Only Bundle Adjustment
...
## 126. PanguMotion: Continuous Driving Motion Forecasting with Pangu Transformers
...
## 127. S-VAM: Shortcut Video-Action Model by Self-Distilling Geometric and Semantic Foresight
...
## 128. SignNav: Leveraging Signage for Semantic Visual Navigation in Large-Scale Indoor Environments
...
## 129. An FPGA-Based SoC Architecture with a RISC-V Controller for Energy-Efficient Temporal-Coding Spiking Neural Networks

**中文标题**: An FPGA-Based SoC Architecture with a RISC-V Controller for Energy-Efficient Temporal-Coding Spiking Neural Networks

**作者**: Mohammad Javad Sekonji, Ali Mahani, Maryam Mirsadeghi, Mahdi Taheri

**发布日期**: 2026-03-17

**arXiv ID**: [2603.18054v1](http://arxiv.org/abs/2603.18054v1)

**PDF**: [下载链接](http://arxiv.org/pdf/2603.18054v1)
...
## 130. Cascade-Aware Multi-Agent Routing: Spatio-Temporal Sidecars and Geometry-Switching
